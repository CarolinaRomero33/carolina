...
func (s *Scanner) scanIdent() (tok Token, lit string) {
	...
	case "zIF":
		return zIF, buf.String()
	case "zELSE":
		return zELSE, buf.String()
	case "zEND":
		return zEND, buf.String()
	case "zSWITCH":
		return zSWITCH, buf.String()
	case "zMAIN":
		return zMAIN, buf.String()
	case "zFUNC":
		return zFUNC, buf.String()
	case "zFOR":
		return zFOR, buf.String()
	case "zELSEIF":
		return zELSEIF, buf.String()
	case "VAR":
		return VAR, buf.String()
	case "zBREAK":
		return zBREAK, buf.String()
	case "zWHILE":
		return zWHILE, buf.String()
	case "zDO":
		return zDO, buf.String()
	case "zINT":
		return zINT, buf.String()
	case "zTRY":
		return zTRY, buf.String()
	case "zCATCH":
		return zCATCH, buf.String()
	case "zFINALLY":
		return zFINALLY, buf.String()
	case "zPOINT":
		return zPOINT, buf.String()
	case "zNEW":
		return zNEW, buf.String()
	case "zFIXED":
		return zFIXED, buf.String()
	case "zUNCHECKED":
		return zUNCHECKED, buf.String()
	case "zFOREACH":
		return zFOREACH, buf.String()
	case "zIMPORT":
		return zIMPORT, buf.String()
